...
struct SirenInterfaceImpl : public NpuDialectInterface {
  using NpuDialectInterface::NpuDialectInterface;

  void printSomeInfo() const override {
    llvm::outs() << "Populating lowering patterns for SirenDialect\n";
  }
};
...
#include "npu-mlir/Dialect/Siren/IR/SirenOps.cpp.inc"
      >();
  addInterfaces<SirenInterfaceImpl>();
}
